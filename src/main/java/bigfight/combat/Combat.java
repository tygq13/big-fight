...
public class Combat {
    ...
    private Empowerment selectEmpowerment(Fighter attacker, Fighter defender, CombatRandom random) {
        Empowerment empowerment = attacker.getCombatSelector().selectEmpowerment(random, attacker.getFighterFlag(), attacker.getBuffs());
        ...
        while (empowerment.getSkill() != null && empowerment.getSkill().getIdentity() == SkillIdentity.DISARM &&
            ...
            empowerment = attacker.getCombatSelector().selectEmpowerment(random, attacker.getFighterFlag(), attacker.getBuffs());
        }
        return empowerment;
    }
}
